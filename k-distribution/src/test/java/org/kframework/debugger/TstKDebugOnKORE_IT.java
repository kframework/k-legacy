 ...
 */
public class TstKDebugOnKORE_IT extends AbstractTest {
    ...
    public void setup() throws URISyntaxException, IOException {
        ...
        debuggerSession = new KoreKDebug(parsed, new KoreUtils(fileName, "IMP", "IMP-SYNTAX", kem).getRewriter(), new Integer(500), null, utils.kem, kRunOptions, utils.compiledDef);
    }
