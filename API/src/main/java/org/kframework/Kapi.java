...
public class Kapi {
    ...
    public RewriterResult krun(CompiledDefinition compiledDef, String programText, Integer depth, String prove, String prelude) {
        ...
        K program = KRun.getInitConfig(pgm, compiledDef, kem);
    ...
    public static void main(String[] args) {
        ...
        /*
        // krun
        RewriterResult result1 = krun(compiledDef1, pgm1, null, null, null);
        kprint(compiledDef1, result1);
        RewriterResult result2 = krun(compiledDef2, pgm2, null, null, null);
