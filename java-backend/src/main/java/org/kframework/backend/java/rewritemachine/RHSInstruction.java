...
public final class RHSInstruction implements Serializable {
    ...
    public static class Constructor implements Serializable {
        ...
        private final org.kframework.frontend.Sort cellCollectionSort;
        ...
        public Constructor(ConstructorType type, int size1,
                           ...
                           org.kframework.frontend.Sort cellCollectionSort) {
        ...
        public Constructor(ConstructorType type, int size1,
                           int size2, int size3, Kind kind, org.kframework.frontend.Sort cellCollectionSort,
        ...
        public org.kframework.frontend.Sort cellCollectionSort() {
