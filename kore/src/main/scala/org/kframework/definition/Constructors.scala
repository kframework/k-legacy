...
object Constructors {
  ...
  def Subsort(sort: Sort, supersort: Sort) = definition.Subsort(sort, supersort, Att())
  def Subsort(sort: Sort, supersort: Sort, att: attributes.Att) = definition.Subsort(sort, supersort, att)
