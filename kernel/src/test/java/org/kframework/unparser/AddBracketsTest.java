...
public class AddBracketsTest {
    ...
    private K parseTerm(String pgm, ParseInModule parser) {
        Tuple2<Either<Set<ParseFailedException>, Tuple2<K, K>>, Set<ParseFailedException>> result = parser.parseString(pgm, Sorts.K(), Source.apply("generated by AddBracketsTest"));
        assertEquals(0, result._2().size());
        return TreeNodesToKORE.down(result._1().right().get()._1());
    }
