...
public class RuleGrammarTest {
    ...
    private void parseRule(String input, String def, int warnings, boolean expectedError) {
        ...
        Tuple2<Either<Set<ParseFailedException>, Tuple2<K, K>>, Set<ParseFailedException>> rule = parser.parseString(input, startSymbol, Source.apply("generated by RuleGrammarTest"));
    ...
    private void parseProgram(String input, String def, String startSymbol, int warnings, boolean expectedError) {
        ...
        Tuple2<Either<Set<ParseFailedException>, Tuple2<K, K>>, Set<ParseFailedException>> rule = parser.parseString(input, Sort(startSymbol), Source.apply("generated by RuleGrammarTest"));
        printout(rule, warnings, expectedError);
    }

    private void printout(Tuple2<Either<Set<ParseFailedException>, Tuple2<K, K>>, Set<ParseFailedException>> rule, int warnings, boolean expectedError) {
