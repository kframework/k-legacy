...
import org.kframework.legacykore.compile.checks.CheckListDecl;
...
//                .collect(Collectors.toSet());
    ...
    public Set<org.kframework.definition.Sentence> apply(Syntax s) {
        ...
        org.kframework.legacykore.Sort sort = apply(s.getDeclaredSort().getRealSort());
    ...
    public void applyUserList(Set<org.kframework.definition.Sentence> res,
                              org.kframework.legacykore.Sort sort, Production p, UserList userList) {

        // Transform list declarations of the form Es ::= List{E, ","} into something representable in kore
        org.kframework.legacykore.Sort elementSort = apply(userList.getSort());
    ...
    public org.kframework.legacykore.Sort apply(org.kframework.kil.Sort sort) {
