...
import org.kframework.legacykore.KList;
...
public class KILtoInnerKORE extends KILTransformation<K> {
    ...
    public org.kframework.legacykore.KSequence apply(KSequence seq) {
    ...
    public org.kframework.legacykore.KApply apply(Bracket b) {
